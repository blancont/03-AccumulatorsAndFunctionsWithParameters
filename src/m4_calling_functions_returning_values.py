...
def run_test_digits_in_power():
    ...
    ans = digits_in_power(1, 2)
    expect = 1
    print('Test 1 should yield', expect)
    print('               ans:', ans)

    ans = digits_in_power(2, 3)
    expect = 8
    print('Test 2 should yield', expect)
    print('               ans:', ans)

    ans = digits_in_power(3, 4)
    expect = 9
    print('Test 3 should yield', expect)
    print('               ans:', ans)
...
def run_test_fancy_sums_of_digits():
    ...
    # ------------------------------------------------------------------
    ans = fancy_sums_of_digits(10)
    expect = 1
    print('Test 1 should yield', expect)
    print('               ans:', ans)

    ans = fancy_sums_of_digits(2)
    expect = 19084
    print('Test 2 should yield', expect)
    print('               ans:', ans)

    ans = fancy_sums_of_digits(35)
    expect = 124309
    print('Test 3 should yield', expect)
    print('               ans:', ans)
