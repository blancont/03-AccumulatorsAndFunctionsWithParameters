...
def draw_circles1():
    ...
    for k in range(21):
        circ = rg.Circle(rg.Point(200, 200), k * 10)
...
def draw_circles2():
    ...
    for k in range(18):
        circ = rg.Circle(rg.Point(((k * 20) + 50), 100), 10)
...
def draw_circles3():
    ...
    for k in range(100):
        circ = rg.Circle(rg.Point(200, 150), k+1)
        circ.attach_to(window)
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        circ = rg.Circle(rg.Point(200 + (80 * math.cos(k)), 200 + (80 * math.sin(k))), 10)
        circ.attach_to(window)
